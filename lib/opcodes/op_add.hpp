...
class vop_add_t : public vopcode_t {
public:
...
public:
	vopcode_t* mutate( std::default_random_engine& rand_engine ) override {
		switch ( rand_engine() % 5 ) {
			case 0: return new vop_add_t();
			case 1: return new vop_add_bc_1_t();
			case 2: return new vop_add_bc_2_t();
			case 3: return new vop_add_bc_3_t();
			case 4: return new vop_add_bc_4_t();
		}
